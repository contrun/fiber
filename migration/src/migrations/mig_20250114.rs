...
impl Migration for MigrationObj {
    fn migrate(
            ...
            .take_while(move |(col_key, _)| col_key.starts_with(prefix.as_slice()))
        {
            ...
            let serialized = bincode::serialize(&old_channel_state).unwrap();
            let new_channel_state = bincode::deserialize::<MyChannelActorState>(&serialized)
                .expect("deserialize to new state");
